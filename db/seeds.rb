...
Brand.create(name: 'Starbucks', logo: 'https://www.universityvillageriverside.com/wp-content/uploads/2018/03/starbucks_logo.jpg', password: "asdf", password_confirmation: "asdf", email: 'starbuck@starbucks.com')
...
CouponInstance.create(coupon_id: 1, logo:'https://rmhckc.org/wp-content/uploads/2018/08/Dr-Pepper-Logo.jpg', issue_date: "1-1-2012".to_date, status: "pending", date_used: "1-1-2019".to_date, barcode: "78907", user_id: 1)
CouponInstance.create(coupon_id: 2, logo: 'https://2.bp.blogspot.com/-O24JiqbqAnY/UhspDiewMUI/AAAAAAAAAlI/gbZrf9jXNOg/w1200-h630-p-k-no-nu/Logo+Duracell.JPG', issue_date: "1-1-2012".to_date, status: "pending", date_used: "1-1-2019".to_date, barcode: "61524 ", user_id: 1)
