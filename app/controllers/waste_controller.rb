...
class WasteController < ApplicationController
    def create
        ...
        res =  conn.post do |req|
            req.url 'https://gateway.watsonplatform.net/visual-recognition/api/v3/classify/'
        end
        ...
        # puts = response.body["images"][0]["classifiers"][0]["classes"][0]["class"]
        # puts = response.body["images"][0]["classifiers"][0]["classes"][0]["score"]
